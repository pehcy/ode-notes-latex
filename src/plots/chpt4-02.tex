\begin{center}
    ...
    % Dashed lines (y-axis)
    \addplot[color = orange, dashed, thick] coordinates {(0, 1) (8, 1)};
    \addplot[color = orange, dashed, thick] coordinates {(0, 5) (8, 5)};

    % Dashed lines (x-axis)
    \addplot[color = orange, dashed, thick] coordinates {(2, 0) (2, 5)};
    \addplot[color = orange, dashed, thick] coordinates {(8, 0) (8, 5)};
